...
const apiKey = "d862ba06d1msh308ef27dc77b4afp1eeb10jsnef18c0065803";
const apiHost = "exercisedb.p.rapidapi.com";
const apiUrl = "https://exercisedb.p.rapidapi.com/exercises/bodyPart/back?limit=10";
...
async function fetchExercises() {
  const response = await fetch(apiUrl, {
    method: "GET",
    headers: {
      "X-RapidAPI-Key": "d862ba06d1msh308ef27dc77b4afp1eeb10jsnef18c0065803",
  ...
  exercises.forEach((exercise) => {
    ...
    if (gifUrl) {
      ...
      exerciseCard.addEventListener("click",()=>{
        window.location.href=`excercise-deatil/id=${exercise.id}`;
      })
...
function createExerciseTypeCards() {
  exerciseTypes.forEach((exerciseType) => {
    ...
    image.src="static/images/gym-logo.png";
    image.alt="gym logo";
